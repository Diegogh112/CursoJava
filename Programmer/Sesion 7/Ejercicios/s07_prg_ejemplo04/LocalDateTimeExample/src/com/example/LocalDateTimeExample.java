...
public class LocalDateTimeExample {
  ...
  public static void main(String[] args) {
    ...
    long courseHrs =  (courseStart.until(courseEnd, HOURS));
            //(courseEnd.getHour() - courseStart.getHour()) * (courseStart.until(courseEnd, DAYS)+1);
            //(courseEnd.getHour() - courseStart.getHour());
            //* (courseStart.until(courseEnd, DAYS)+1);
    out.println("Course is:     " + courseHrs + " hours long.");


    meeting = LocalDateTime.now();
    out.println("Fecha y Hora actual "+meeting);
  }
