...
public class ZonedDateTimeExample {
  ...
  public static void main(String[] args) {
    ...
    //ZoneId USEast = ZoneId.of("America/Chicago");
    //ZoneId USEast = ZoneId.of("America/Los_Angeles");
    //ZoneId USEast = ZoneId.of("America/Phoenix");
    //ZoneId USEast = ZoneId.of("America/Denver");
    //zona horaria de Lima
    //ZoneId USEast = ZoneId.of("America/Lima");
    //zona horaria de china
    ZoneId USEast = ZoneId.of("Asia/Shanghai");
