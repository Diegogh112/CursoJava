...
import útil.MisConstantes;

import java.time.LocalTime;
import java.util.List;

public class Evento {
    private static final MisConstantes misConstantes;
    ...
    public void establecerCostoIngreso(String codigo){
        switch (codigo){
            case "P": costoEntrada = misConstantes.getCosto()
        }
    }
